...
pub use client::{
    ...
    root_store_from_der, verify_webpki_server_certificate_chain_at, BoundedHttpsRequest,
    ClientCertIdentity, EnclaveAttestationProvider, EnclaveClientCertSigner, ExpectedOid,
    HttpResponse, HttpsFetchError, HttpsFetchFailurePhase, IncrementalTlsClient,
    InterruptibleBlockingNetIo, RaTlsPolicy, ReportDataBinding, SgxPeerCertificateEvidence,
    TeeType, TlsPeerCertificateChain, TlsPeerCertificateEvidence, MAX_REQUEST_BODY,
    MAX_REQUEST_HEADERS, MAX_REQUEST_HEADER_BYTES, MAX_RESPONSE_BODY, MAX_RESPONSE_HEADERS,
    MAX_RESPONSE_HEADER_BYTES, MAX_TLS_PEER_CERTIFICATES, MAX_TLS_PEER_CERTIFICATE_BYTES,
    MAX_TLS_PEER_CHAIN_BYTES, OID_ATTESTATION_SERVERS_HASH, OID_CONFIG_MERKLE_ROOT,
